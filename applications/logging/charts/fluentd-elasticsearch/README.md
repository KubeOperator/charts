...
**This is a fork of https://github.com/kiwigrid/helm-charts/tree/master/charts/fluentd-elasticsearch for GitLab.com**
...
```console
helm install --name fluentd-elasticsearch
```
...
| `elasticsearch.index_name`                   | Elasticsearch index name to write events to                                    | `""`                                   |
| `elasticsearch.logstashPrefix`               | Elasticsearch Logstash prefix                                                  | `logstash`                             |
| `elasticsearch.logEs400Reason`               | Elasticsearch Log reasons for 400 errors                                       | false                                  |
